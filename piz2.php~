...
<center><p style="color:white;text-align:center;font-size:30px;padding-right:250px;padding-left:90px;padding-top:20px;padding-bottom:20px;background-color:black;opacity:0.5;">Pizzas</p></center>
</div>
<?php 
include 'connection.php';
