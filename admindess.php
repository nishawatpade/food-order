...
<form method="post" action="">
	<input style="margin-left:300px;" type="text" placeholder="Search here" name="search">
...
if(isset($_POST['find']))
{
	...
	if(mysqli_num_rows($result2)>0)
	{
		...
		<div class="dishname"></input>INR:<?php echo $row['cost']?></div>
		<div class="dishname">
		</div>
...
<center><p style="color:white;text-align:center;font-size:30px;padding-right:250px;padding-left:90px;padding-top:20px;padding-bottom:20px;background-color:black;opacity:0.5;">Desserts</p></center>
</div>
<?php 
include 'connection.php';
